...
class Pdaig_website extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //************************************************************************
    Future PdaigWeb() async{
      var _tab = await DB.initTabquery();
      return _tab;
    }
    final _PdaigWebsite = FutureBuilder(
        future: PdaigWeb(),
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          ...
          return snap[0]['site_pdaig'] != null || snap[0]['site_pdaig'] != "" ?
            Builder(builder: (BuildContext context) {
            return WebView(
              initialUrl: '${snap[0]['site_pdaig']}',
          ...
          }) : Container(child: Text('Pas de url !!!'));
        }
    );

    return Scaffold(
      appBar: AppBar(
        title: const Text('Site web Pdaig'),
