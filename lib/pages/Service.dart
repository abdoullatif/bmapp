...
class _serviceRecuState extends State<serviceRecu> {
  ...
  Widget build(BuildContext context) {
    ...
    if(service_recu == "Non" || service_recu == ""){
      formul = false;
    } else {
      formul = true;
    }
                              ...
                              onPressed: () async{
                                if (_formKey3.currentState.validate()) {
                                  ...
                                  await DB.insert("services_recus", {
                                    ...
                                    "type_service": _nature_service.text,
                                  ...
                                  Fluttertoast.showToast(
                                      msg: "Enregistrement des services récus effecté avec succès ! ", //Présence enregistrée,
