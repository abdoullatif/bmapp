...
//environnement
class Environnement extends StatefulWidget {
  @override
  _EnvironnementState createState() => _EnvironnementState();
}

class _EnvironnementState extends State<Environnement> {
  @override
  Widget build(BuildContext context) {
    ...
    final _environnement = FutureBuilder(
        future: Media(),
          ...
          child: Column( //future builder
            children: <Widget>[
              Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("images/environnement-large.png"),
                      fit: BoxFit.cover,
                    )
                ),
              ),
                ...
                child: Center(
                  child: Container(
                      ...
                      child: Align(
                        ...
                        child: Container(
                          child: Text("Environnement", style: TextStyle(color: Colors.white, fontSize: 20.0, fontWeight: FontWeight.bold,),),
                        ),
                      )
                  ),
                ),
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Card(
                        elevation: 10,
                        child: Image.asset("images/environnement-banner.png"),
                      ),
                    ),
                    Container(
                      ...
                      child: Card(
                        elevation: 10,
                        child: ListTile(
                          //title: Text('Protegeons notre environnement', style: TextStyle(color: Colors.black, fontSize: 18.0, fontWeight: FontWeight.bold,),textAlign: TextAlign.center,),
                          subtitle: Text('L’environnement influence beaucoup le bien-être, la santé et le régime alimentaire. Un environnement malsain conduit ses habitants à la maladie, à la mort. Dans les pays africains et certains comme l’Inde, bon nombre de maladies sont traités à partir des racines, des écorcés et des feuilles de certaines plantes dites médicinales de par leur vertu médicale. La préservation de l’environnement est importante pour le développement durable des générations actuelles et de celles de l’avenir'
                  ...
                  children: <Widget>[
                    Expanded(
                      child: RaisedButton(
                        ...
                        disabledColor: Colors.transparent,
                        onPressed: (){
                          String video = "videos/environnement.mp4";
                          //Visionage de la video sur page unique
                          Navigator.push(context, MaterialPageRoute(
